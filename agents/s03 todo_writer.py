    ...
    },
    {
        ...
        "input_schema":{
            ...
            "properties":{
                "todos":{
                    "type": "array",
                    "description": "The todos to update",
                    "items":{ # 每个 todo 项的 schema
                        "type": "object",
                        "properties":{
                            "id":{
                                "type": "string"
    ...
    while loop_count < max_loops:
        ...
        for block in response.content:
            ...
            try:
                ...
                print(f"\033[90m[Tool] {block.name}: \n{display_out}\033[0m")
                ...
                error_msg = f"Error in tool call: {e}"
        ...
        if rounds_since_todo >= 3: # 如果 3 轮内没有调用 todo 工具，提醒用户更新 todo
...
if __name__ == "__main__":
    ...
    while True:
        ...
        try:
            query = input(f"\033[36ms03 ({MODEL}) >> \033[0m")
